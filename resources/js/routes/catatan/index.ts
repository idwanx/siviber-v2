...
* @see app/Http/Controllers/Berkas/CatatansController.php:27
* @route '/catatan/store'
*/
...
* @see app/Http/Controllers/Berkas/CatatansController.php:73
...
* @see app/Http/Controllers/Berkas/CatatansController.php:106
...
/**
* @see \App\Http\Controllers\Berkas\CatatansController::destory
* @see app/Http/Controllers/Berkas/CatatansController.php:138
* @route '/catatan/destroy/{catatan_berka}'
*/
export const destory = (args: { catatan_berka: string | number } | [catatan_berka: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destory.url(args, options),
    method: 'delete',
})
...
* @route '/catatan/destroy/{catatan_berka}'
*/
destory.url = (args: { catatan_berka: string | number } | [catatan_berka: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { catatan_berka: args }
    }
...
* @route '/catatan/destroy/{catatan_berka}'
*/
destory.delete = (args: { catatan_berka: string | number } | [catatan_berka: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destory.url(args, options),
    method: 'delete',
})
...
* @route '/catatan/destroy/{catatan_berka}'
*/
const destoryForm = (args: { catatan_berka: string | number } | [catatan_berka: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: destory.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'DELETE',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
* @route '/catatan/destroy/{catatan_berka}'
*/
destoryForm.delete = (args: { catatan_berka: string | number } | [catatan_berka: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: destory.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'DELETE',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
destory.form = destoryForm

const catatan = {
    index: Object.assign(index, index),
    store: Object.assign(store, store),
    update: Object.assign(update, update),
    updateChecked: Object.assign(updateChecked, updateChecked),
    destory: Object.assign(destory, destory),
}
